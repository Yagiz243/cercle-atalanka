...
export function AdminTeachings() {
  ...
  const handleDelete = async (id: string) => {
    if (confirm('ÃŠtes-vous sÃ»r de vouloir supprimer cet enseignement?')) {
      try {
  ...
  const handleCreateTeaching = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (isSupabaseConfigured && videoFile) {
        const videoPath = 'admin/' + videoFile.name;
      ...
      if (isSupabaseConfigured && imageFile) {
        const imagePath = 'admin/' + imageFile.name;
      ...
      setError(createError instanceof Error ? createError.message : 'Impossible de creer cet enseignement.');
    } finally {
      setIsSaving(false);
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">GÃ©rez vos contenus pÃ©dagogiques</p>
        </div>
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Creez un contenu avec texte, video et/ou photo depuis ce formulaire. {!isSupabaseConfigured && 'Mode dÃ©mo: les fichiers uploadÃ©s ne seront pas stockÃ©s, des images par dÃ©faut seront utilisÃ©es.'}
              </DialogDescription>
            </DialogHeader>
            ...
            <form className="space-y-4" onSubmit={handleCreateTeaching}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="teaching-category" className="text-sm font-medium">Categorie</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="text_video">Texte + Video</option>
                    <option value="text_photo">Texte + Photo</option>
                    <option value="text">Texte</option>
                  </select>
                </div>
                <div className="space-y-2">
                  <label htmlFor="teaching-duration" className="text-sm font-medium">Duree (optionnel)</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="teaching-video-url" className="text-sm font-medium">URL video (optionnel)</label>
                ...
                <div className="space-y-2">
                  <label htmlFor="teaching-video-file" className="text-sm font-medium">Upload video {!isSupabaseConfigured && '(dÃ©sactivÃ© en mode dÃ©mo)'}</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="teaching-image-file" className="text-sm font-medium">Upload photo {!isSupabaseConfigured && '(dÃ©sactivÃ© en mode dÃ©mo)'}</label>
              ...
              <DialogFooter>
                ...
                <Button type="submit" variant="accent" disabled={isSaving}>
                  {isSaving ? 'Creation...' : 'Creer l\'enseignement'}
                </Button>
              </DialogFooter>
            </form>
          </DialogContent>
        ...
        <CardContent className="p-6">
            ...
            <table className="w-full">
              <thead className="border-b border-border">
                <tr className="text-left">
                  ...
                  <th className="pb-3 font-semibold">CatÃ©gorie</th>
                  <th className="pb-3 font-semibold">DurÃ©e</th>
          ...
          {filteredTeachings.length === 0 && (
            <div className="text-center py-12">
              <p className="text-muted-foreground">Aucun enseignement trouvÃ©</p>
            </div>
          )}
        </CardContent>
      </Card>
