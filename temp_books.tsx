  ...
  const handleCreateBook = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (isSupabaseConfigured && coverFile) {
        const coverPath = 'admin/' + coverFile.name;
      ...
      if (isSupabaseConfigured && pdfFile) {
        const pdfPath = 'admin/' + pdfFile.name;
      ...
      setError(createError instanceof Error ? createError.message : 'Impossible de creer ce livre.');
    } finally {
      setIsSaving(false);
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">G̩rez votre catalogue de livres</p>
        </div>
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Renseignez les informations du livre. {!isSupabaseConfigured && 'Mode d̩mo: les fichiers upload̩s ne seront pas stock̩s, des images par d̩faut seront utilis̩es.'}
              </DialogDescription>
            </DialogHeader>
            ...
            <form className="space-y-4" onSubmit={handleCreateBook}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="book-category" className="text-sm font-medium">Categorie</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="book-cover-file" className="text-sm font-medium">Upload couverture {!isSupabaseConfigured && '(d̩sactiv̩ en mode d̩mo)'}</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="book-pdf-file" className="text-sm font-medium">Upload PDF {!isSupabaseConfigured && '(d̩sactiv̩ en mode d̩mo)'}</label>
              ...
              <DialogFooter>
                ...
                <Button type="submit" variant="primary" disabled={isSaving}>
                  {isSaving ? 'Creation...' : 'Creer le livre'}
                </Button>
              </DialogFooter>
            </form>
          </DialogContent>
